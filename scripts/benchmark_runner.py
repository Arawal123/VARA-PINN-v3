...
BENCHMARK_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "lid_driven_cavity": {
        ...
        "optimizer": {
            ...
            "final_repair": {
                "enabled": True,
                "score_metric": "cavity_benchmark_score",
        ...
        "sampling": {
            ...
            "cavity_focus": {
                "enabled": True,
                "near_wall_fraction": 0.12,
                "centerline_fraction": 0.10,
                "lid_fraction": 0.06,
                "corner_fraction": 0.04,
                "strip_width": 0.08,
                "centerline_width": 0.04,
            },
        },
    },
    "double_vortex_box": {
    ...
    if args.quick:
        ...
        config = deep_update(
            config,
            {
                ...
                "local_controller": {
                    "trial_epochs": 2,
                    "interior_trial_epochs": 2,
                    "wall_trial_epochs": 2,
                    "corner_trial_epochs": 2,
                    "sampling_only_trial_epochs": 2,
